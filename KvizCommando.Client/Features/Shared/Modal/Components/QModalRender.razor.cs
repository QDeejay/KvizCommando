...
using KvizCommando.Localization.Shared.Modal.Question;
...
{
    public partial class QModalRender
    {
        [Inject] private IStringLocalizer<QuestionModalResource> Lang { get; set; } = default!;
