...
public static class RankCatalog
{
    ...
    [
        ...
        new(4, "Lvl-03", "Őrmester", "őrm.", "Sergeant", "SGT"),
        new(5, "Lvl-04", "Törzsőrmester", "tőrm.", "Staff Sergeant", "SSG"),
        new(6, "Lvl-05", "Főtörzsőrmester", "ftőrm.", "Sergeant First class", "SFC"),
        new(7, "Lvl-06", "Zászlós", "zls.", "Warrant Officer", "WO1"),
        new(8, "Lvl-07", "Törzszászlós", "tzls.", "Chief Warrant 2", "CW2"),
        new(9, "Lvl-08", "Főtörzszászlós", "ftzls.", "Chief Warrant 3", "CW3"),
        new(10, "Lvl-09", "Hadnagy", "hdgy.", "Second Lieutenant", "2LT"),
        new(11, "Lvl-10", "Főhadnagy", "fhdgy.", "Lieutenant", "1LT"),
        ...
        new(17, "Lvl-16", "Vezérőrnagy", "vőrgy.", "Major General", "MG"),
        ...
        new(23, "Lvl-MX1", "Minisztériumvezető", "miv.", "Head of ministry", "HOM"),
        new(24, "Lvl-MX2", "Kvíz Miniszterelnök", "kme.", "Quiz Prime Minister", "PRM"),
