        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TermsConsents_IpHash_Len", "IpHash IS NULL OR length(IpHash) = 32");
                    table.CheckConstraint("CK_TermsConsents_UserAgentHash_Len", "UserAgentHash IS NULL OR length(UserAgentHash) = 32");
                });
