...
public sealed class VsMatchPlayerState
{
    ...
    public int AnswerableQuestionNumber { get; set; }
...
public sealed class VsMatchGameState
{
    ...
    public int SpeedBonusPoolPoints { get; set; }
...
public sealed class VsMatchRoundResultState
{
    ...
    public int FastestBonusPoints { get; init; }
    public bool HasSpeedPositionGain { get; init; }
