...
public sealed class VsMatchRewardPersistenceService
{
        ...
        int playerCount)
    {
        ...
        if (reward.ActualPoints <= 0 ||
            reward.ActualPoints < statistics.RankedHighScore ||
            reward.ActualPoints == statistics.RankedHighScore &&
        ...
        statistics.RankedHighScore = reward.ActualPoints;
...
/**
 * ÚJ FÁJL: a lezárt ranked meccs kiszámolt eredményét a
 * meglévő PlayerCache saját játékoslockján vezeti át. Mentésre
 * kerül a globális highscore, a 2/3/4 fős helyezés, a jutalom,
 * a segítség- és energiaveszteség, valamint az Ask-, kategória-,
 * sajátkérdés- és karakterduel-statisztika. A levonások nem
 * vihetnek adatot nulla alá. A bot csak a tétet, hozzárendelt
